...
#TypeA
    ...
    def find_search_index_due_date(self, task):
        return
    ...
    def sign_contracts(self, list: List[Agree]):
        ...
        for agreements in list:
            ...
            for task in min_cost:
                ...
                if min_cost[task] < cost_border:
                    signed.append(min_cost_agreement[task])
        return signed
    ...
    def calculate_cost_saving(self,agreements: Agree):
        ...
        over_late = 0.5 * (self.bulletin_board.n_steps / self.bulletin_board.max_steps) ** 2
        distance_late = 0.5
